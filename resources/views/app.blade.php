            ...
            <nav class="bg-gray-200 flex h-16 w-full z-10 fixed top-0">
                ...
                <ul class="w-full lg:w-auto my-32 lg:my-0 bg-gray-200 script-toggle self-center font-secundary lg:mr-12 hidden lg:block fixed lg:static">
                    <li class="text-center lg:text-left block lg:inline lg:mr-8 py-3 lg:py-0">
                        <a class="border-b-2 border-gray-200 hover:border-highlight text-xl lg:text-base" title="" href="#about">About</a>
                    </li>
                    <li class="text-center lg:text-left block lg:inline lg:mr-8 py-3 lg:py-0">
                        <a class="border-b-2 border-gray-200 hover:border-highlight text-xl lg:text-base" title="" href="#skills">Skills</a>
                    </li>
                    <li class="text-center lg:text-left block lg:inline lg:mr-8 py-3 lg:py-0">
                        <a class="border-b-2 border-gray-200 hover:border-highlight text-xl lg:text-base" title="" href="#portfolio">Portfolio</a>
                    </li>
                    <li class="text-center lg:text-left block lg:inline py-3 lg:py-0">
                        <a class="border-b-2 border-gray-200 hover:border-highlight text-xl lg:text-base" title="" href="#contact">Contact</a>
                    </li>
                </ul>
                <a id="script-toggle-button" class="self-center lg:hidden mr-6 fixed right-0 z-10" href="javascript:void(0);">
        ...
        <div class="py-16 text-center border-b relative">
            ...
            <div class="p-6 flex flex-wrap lg:flex-no-wrap m-auto w-full">
                ...
                <div class="w-full mx-auto lg:w-1/2 max-w-sm rounded overflow-hidden shadow-xl hover:shadow-2xl m-6">
                    <img class="mt-12 mx-auto w-32 h-32 rounded-full" src="/images/rick-blackandwhite.jpg" alt="Sunset in the mountains">
                    <div class="px-6 py-4">
                    ...
                    <div class="px-4 py-4">
                        <a href="tel:+32468047774" title="+32 468 047 774" class="inline-block bg-support hover:bg-highlight text-white rounded-full my-2 px-2 py-2 text-xs sm:text-sm mr-2">
                            +32 468 047 774
                        </a>
                        <a href="mailto:rick@webathletes.nl" title="rick@webathletes.nl" class="inline-block bg-support hover:bg-highlight text-white rounded-full my-2 px-2 py-2 text-xs sm:text-sm mr-2">
                            rick@webathletes.nl
                        </a>
                    </div>
                </div>
        ...
        <div class="py-16 text-center relative">
            ...
            <div class="p-6 flex flex-wrap sm:flex-no-wrap mx-auto w-full lg:w-2/3">
                <div class="w-full sm:w-1/2 rounded overflow-hidden shadow-lg hover:shadow-2xl mx-4">
                    ...
                    <div class="px-4 py-4">
                        <span class="inline-block bg-support hover:bg-highlight text-white rounded-full my-2 px-2 py-2 text-xs sm:text-sm mr-2">#PHP73</span>
                        <span class="inline-block bg-support hover:bg-highlight text-white rounded-full my-2 px-2 py-2 text-xs sm:text-sm mr-2">#LARAVEL</span>
                        <span class="inline-block bg-support hover:bg-highlight text-white rounded-full my-2 px-2 py-2 text-xs sm:text-sm">#MYSQL</span>
                        <span class="inline-block bg-support hover:bg-highlight text-white rounded-full my-2 px-2 py-2 text-xs sm:text-sm">#TAILWINDCSS</span>
                    </div>
                </div>
            </div>
        </div>
